import 'package:app_web_admin/controllers/order_controller.dart';
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        orderData(3, Text(order.productName)),
                        orderData(
                          2,
                          Text('\$${order.productPrice.toStringAsFixed(2)}'),
                        ),
                        orderData(2, Text(order.category)),
                        orderData(3, Text(order.fullName)),
                        orderData(3, Text(order.email)),
                        orderData(3, Text('${order.city}, ${order.state}')),
                        orderData(
                          2,
                          Text(
