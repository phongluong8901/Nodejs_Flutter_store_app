...
import 'package:fullstack_app/views/screens/detail/screens/shipping_address_screen.dart';
...
class _AccountScreenState extends ConsumerState<AccountScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //fetch the deliverd order count twhen the weidget build
    ref
        .read(deliveredOrderCountProvider.notifier)
        .fetchDeliveredOrderCount(buyerId, context);
    //wtach the delivered OrderCount Provider to reactively rebuild wjhen state change
